...
In this demo we'll explore tap, long tap, drag, rotation gestures, Developed using SwiftUI.
...
1. Clone the repo
   ```sh
   git clone https://github.com/Mobile-Apps-Academy/GesturesDemoSwiftUI.git
   ```
